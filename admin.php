...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="admin.php">Data barang</a>
        </li>
        <li class="nav-item">
  ...
  <div class="mx-auto">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        if ($error) {
          ...
          <?php
          header("refresh:3;url=admin.php"); //3 : detik
        }
        ?>
        <?php
        if ($sukses) {
          ...
          <tbody>
            ...
            while ($r2 = mysqli_fetch_array($q2)) {
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="admin.php?op=edit&id=<?php echo $id_barang ?>"><button type="button"
                      class="btn btn-warning">Edit</button></a>
                  <a href="admin.php?op=delete&id=<?php echo $id_barang ?>"> <button type="button" class="btn btn-danger"
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"
      integrity="sha384-HwwvtgBNo3bZJJLYdoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
</body>
