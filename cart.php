...
if (isset($_GET["action"])) {
    if ($_GET["action"] == "delete") {
        ...
        if (isset($_POST['submit'])) {
            ...
            $alamat = $_POST['alamat'];
            $query = mysqli_query($koneksi, "INSERT INTO transaksi(id_pembeli,alamat,tgl_transaksi,total_harga) VALUE ('$id_pembeli','$alamat','" . date("Y-m-d") . "','$subtotal')");
        }
        ...
        <div class="row no-gutters">
            <div class="col-md-8">
                <div class="product-details mr-2">
                    <div class="d-flex flex-row align-items-center"> <a href="index.php"><i
                        ...
                        foreach ($_SESSION["cart"] as $key => $value) {
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                                ...
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <a href="cart.php?action=delete&id=<?= $value['product_id'] ?>"><i
            ...
            <div class="col-md-4">
                <div class="payment-info">
                    ...
                    <form action="cart.php?action=beli" method="post">
                        ...
                        <div class="d-flex justify-content-between information"><span>Taxes</span><span>Rp.
                                <?php echo number_format($ppn) ?>
                            </span></div>
                        <div class="d-flex justify-content-between information"><span>Total (incl taxes)</span><span>Rp.
                                <?php echo number_format($subtotal = $total + $ppn, 2); ?>
                            </span></div>
                        <input type="submit" class="btn btn-primary btn-block d-flex justify-content-between mt-3"
                            name="submit" value="Rp.<?php echo number_format($subtotal = $total + $ppn, 2); ?> Checkout">
                        </input>
                </div>
                </form>
